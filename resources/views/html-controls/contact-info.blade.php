...
<div class="tags-form">
	...
	<div class="control-label">
		...
		{{ Form::select('contacts[' . $i . '][type]', $contactOptions, $type, ['class'=>'form-control contact-select']  ) }}
		{{ Form::text('contacts[' . $i . '][content]', $content,  ['class'=>'form-control contact-input'])  }}
		</div>
	</div>
</div>
@endfor
