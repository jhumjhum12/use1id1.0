 ...
 <div class="col-md-3 available-templates" style="padding:0 2px 0 0; border: solid 1px #ddd;">
            <div style="background: #fff; padding: 10px">
    			...
    			<div class="row templates">
                    <div class="col-xs-10">
                        <a class="cvb-inline-btn download-populated-template downloadResume" data-template="<?php echo e($key); ?>"  href="<?php echo e(route('resume_template.download', $key)); ?>" ><i class="fa fa-download" aria-hidden="true"></i>
                            &nbsp;<?php echo e($val); ?>
