    ...
    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
        ...
        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> form-group-login">
            ...
            <div class="login-inline inline-field">
                ...
                <input id="email" type="email" class="form-control form-input" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
        ...
        <div class="form-group form-group-login">
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="remember"> <?php echo e(\App\Label::get("remember_me")); ?>
...
<?php echo $__env->make('layouts.app-original', ['class'=>'login-page'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>