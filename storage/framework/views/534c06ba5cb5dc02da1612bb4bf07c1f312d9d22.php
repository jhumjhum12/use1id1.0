...
<div class="table-wrap">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <tr>
            <td><strong><?php if(isset($value->project->customer)): ?> <?php echo e($value->project->customer); ?>/<?php echo e($value->project->project_name); ?><?php endif; ?></strong> </td>
            <td><?php echo e($value->person); ?></td>
            <td><?php echo e($value->job_title); ?></td>
            <td><?php echo e($value->reference_date); ?></td>
            <td><?php echo e($value->position_vs_you); ?></td>
