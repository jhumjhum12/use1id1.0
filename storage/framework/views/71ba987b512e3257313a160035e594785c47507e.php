...
<div class="col-md-12">
<textarea   class=" form-control editor" id="txtareaData"><?php echo e($val); ?></textarea>
<button id="submitTxtareaData" data-id="<?php echo e($id); ?>" class="btn btn-primary cur_pointer">Submit</button> 
</div>
