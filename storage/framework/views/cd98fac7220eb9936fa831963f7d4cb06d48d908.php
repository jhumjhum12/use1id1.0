...
<?php echo $__env->make('layouts.app', ['slug'=>'contacts', 'title'=>'Search 1iD', 'submenu'=>\App\Http\Controllers\ContactsController::getViewSubmenu()], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>