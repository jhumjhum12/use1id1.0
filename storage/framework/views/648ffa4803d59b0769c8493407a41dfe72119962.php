...
<?php if(Auth::check()): ?>
<?php echo $__env->make('layouts.parts.feedback', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
...
<section id="page">
    ...
    <div class="main">
        ...
        <?php echo $__env->make('layouts.parts.breadcrumbs', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make('layouts.parts.alertify', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php if(Auth::check()): ?>
    <?php echo $__env->make('layouts.parts.help', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
