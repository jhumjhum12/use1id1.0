		  ...
		  <li><a class="openTree cur_pointer"><?php echo e($t->description); ?></a>
			...
			<?php if(count($t->childs) >0): ?>
				<?php $__currentLoopData = $t->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<a class="openTree cur_pointer"><?php echo e($ch->description); ?></a>
						  <ul>
							<?php $__currentLoopData = $ch->child1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$ch1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							  <li> 
							  <i class="fa fa-info-circle info-icon"  data-id="<?php echo e($ch1->id); ?>" aria-hidden="true"></i>
				...
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<?php else: ?>
				<?php if(!empty($t->child1)): ?>
					<?php $__currentLoopData = $t->child1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						 
							 <li> 
							 <i class="fa fa-info-circle info-icon"  data-id="<?php echo e($ch->id); ?>" aria-hidden="true"></i>
							 <a OnClick="shownew(this.id);" data-layout="<?php echo e($layout); ?>" class="" id="last_<?php echo e($ch->id); ?>" style="cursor: pointer;"><?php echo e($ch->description); ?></a> </li>
