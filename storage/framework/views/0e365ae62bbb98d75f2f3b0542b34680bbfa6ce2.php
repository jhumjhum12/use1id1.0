...
<?php $__env->startSection('content'); ?>
    ...
    <h2>Sharing Options</h2>
        ...
        <table class="sharing-table">
            <tr class="row-one">
                ...
                <th>Basic Info</th>
                <?php $__currentLoopData = $contact->sharingOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <th><?php echo e($v); ?></th>
    ...
    <?php echo $__env->make('member.contacts.partials.basic-data', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <hr />
    ...
    <?php if($user->companies->count()>0 || $user->employee->count()>0): ?>
        ...
        <?php if($myOwn ||  in_array(2, $share) && in_array(2, $shareInverted) ): ?>
            ...
            <?php if($user->companies->count()>0): ?>
                ...
                <?php echo $__env->make('html-controls.table-builder.companies', ['data'=>$user->companies, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php endif; ?>

            <?php if($user->employee->count()>0): ?>
                <h4><b><?php echo e(Label::get('employee_of')); ?></b></h4>
                <?php echo $__env->make('html-controls.table-builder.companies-employee', ['data'=>$user->employee, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php endif; ?>

        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
        <hr />
    <?php endif; ?>
    ...
    <h2><?php echo e(Label::get('work_experience')); ?></h2>
        <?php if($myOwn ||  in_array(1, $share) && in_array(1, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.work_experience', ['data'=>$user->workExperience, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
    ...
    <h2><?php echo e(Label::get('projects')); ?></h2>
        <?php if($myOwn ||  in_array(3, $share) && in_array(3, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.projects', ['data'=>$user->projects, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
    ...
    <h2><?php echo e(Label::get('references')); ?></h2>
        <?php if($myOwn ||  in_array(4, $share) && in_array(4, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.references', ['data'=>$user->references, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
    ...
    <h2><?php echo e(Label::get('education')); ?></h2>
        <?php if($myOwn ||  in_array(5, $share) && in_array(5, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.education', ['data'=>$user->education, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
    ...
    <h2><?php echo e(Label::get('spoken_languages')); ?></h2>
        <?php if($myOwn ||  in_array(6, $share) && in_array(6, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.spoken_languages', ['data'=>$user->spokenLanguages, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
    ...
    <h2><?php echo e(Label::get('contact_info')); ?></h2>
        <?php if($myOwn ||  in_array(7, $share) && in_array(7, $shareInverted) ): ?>
            <?php echo $__env->make('html-controls.table-builder.contact_info', ['data'=>$user->contactInfo, 'noActions'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('member.contacts.partials.no-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
    <hr />
