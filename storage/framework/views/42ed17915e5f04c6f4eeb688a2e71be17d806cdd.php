<?php $__env->startSection('content'); ?>
			...
			<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-xs-3">
                <input type="text" class="edit-trans"  style="height: 30px;width:70%;"
                  ...
                  data-id="<?php echo e($row[$selectedLng]['id'] or '0'); ?>"
                  data-text="<?php echo e($row[$selectedLng]['msg_txt'] or ''); ?>"
                  value="<?php echo e($row[$selectedLng]['msg_txt'] or ''); ?>"/>
                &nbsp;&nbsp;
                ...
                <span class="error-msg" style="color:red;display:none">Error</span>
                        ...
                        <div class="<?php echo e($cols); ?> text-right">
							...
							<?php $__currentLoopData = $row['_missing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<p>Auto Translate: <br/>
		...
		<ul>
			<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
