<?php $__env->startSection('content'); ?>
    ...
    <div ng-app="myApp" ng-controller="myCtrl" class="angularBuilder">
        ...
        <div class="f f2">
            ...
            <?php echo $__env->make('admin.screen-builder.partials.angular-builder-screens-editor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('admin.screen-builder.partials.angular-builder-screen-editor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('admin.screen-builder.partials.angular-builder-segment-editor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('admin.screen-builder.partials.angular-builder-fields-editor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
        ...
        screensUrl = "<?php echo e(route('builder.angular.partial.index.get')); ?>";
    ...
    <script src="<?php echo e(URL::asset('js/Sortable.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/screen-builder-angular.js')); ?>"></script>
