...
<table class="table table-bordered table-striped mb-0" id="table">
   <thead>
      <tr> 
		<?php if($table_name=='SY_TAB_TABLE_DEFINITIONS'): ?>
         ...
         <?php if(($column!='id') && ($column!='is_active') && ($column!='created_at') && ($column!='updated_at')): ?>							
      <th class="col"><?php echo e($column); ?></th>
      <?php endif; ?>	
   ...
   <tbody id="myTable">
		...
		<?php $__currentLoopData = $table_column; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
		  <?php if(($column!='id') && ($column!='is_active') && ($column!='created_at') && ($column!='updated_at')): ?>	
			<td>
				<input type="text" name="<?php echo e($column); ?>" class=" form-control inputnew cls<?php echo e($column); ?> inputsnew" value="">	
			</td>
		  <?php endif; ?>	
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<td>
   ...
   <?php if($table_name=='SY_TAB_TABLE_DEFINITIONS'): ?>
      ...
      <?php if(($column!='id') && ($column!='is_active') && ($column!='created_at') && ($column!='updated_at')): ?>	
		<td class="allspan span<?php echo e($tab1->id); ?>">	
			 <?php if(($table_name=='SY_TAB_TABLE_DEFINITIONS') && ($column=='description')): ?>
			<span style="font-size:12px;color:blue;" class=""><?php echo e($tab1->$column); ?></span>
			<?php else: ?>
				<span style="font-size:12px;" class=""><?php echo e($tab1->$column); ?></span>
			<?php endif; ?>
		</td>
		<td class="hidedata allinput hide-section input<?php echo e($tab1->id); ?>">
			<input type="text" name="<?php echo e($column); ?>" class="form-control  inputs<?php echo e($tab1->id); ?>" value="<?php echo e($tab1->$column); ?>">	
		</td>
      <?php endif; ?>	
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <td class="hidedata">
