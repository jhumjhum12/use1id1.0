...
class WorkExperience extends Model
{
    ...
    protected $table = "ud_gen_bio_work_experience"; // DV0001
   // protected $table = "work_experience";  // DV0001
    protected $guarded = [ "user_id", "id"];
    public $timestamps = false;
    const REVISION_TYPE = Revision::REVISION_WORK_XP;
    ...
    public function getFields()
    {
        return
            [
                ...
                'company_name'=> [ 'label'=>'company_name', 'validation'=>'required', 'type'=>'text'  ],
    ...
    {		
        if(Input::get('id')) {			
            ...
            if($wo) {
				...
				$project=Project::where('work_experience_id', Input::get('id'))->where('is_active','1')->get()->toArray();
				if(empty($project))
				{				
				...
				{
					Notification::error("You have project on this perticular workexperience.");
					 //return false;
				}
